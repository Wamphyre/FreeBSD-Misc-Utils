...
pkg install -y nano curl htop wget git nginx apache24 mariadb102-client mariadb102-server php71 php71-mysqli mod_php71 php71-mbstring php71-gd php71-json php71-mcrypt php71-zlib php71-curl php71-session;
