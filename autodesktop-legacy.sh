#!/bin/bash
echo AutoDesktop-legacy by Wamphyre
echo Version 1.0
...
echo Bienvenido al script de instalación AutoDesktop-Legacy
sleep 1

echo ¡¡ADVERTENCIA¡¡ Este Script debe ejecutarse en un sistema FreeBSD recien instalado y limpio.
echo Instalaremos un entorno de escritorio XFCE completo y funcional con los drivers legacy NVIDIA.
sleep 1
...
sleep 3
pkg install xarchiver zip rar xfce4-volumed-pulse xfce4-goodies thunar-archive-plugin numix-theme mate-icon-theme-faenza slim-themes deadbeef filezilla bluefish gimp claws-mail openshot frei0r-plugins audacity jamin transmission
...
echo Compilando e instalando los drivers NVIDIA-legacy disponibles...
sleep 3
...
echo Instalacion driver NVIDIA-legacy finalizada
sleep 2
...
echo Tu entorno de escritorio XFCE4 para FreeBSD con drivers NVIDIA Legacy ya está instalado, configurado y securizado.
sleep 2
